...
const BlogCard = ({ title, date, link, description }: Props) => (
  <div className="shadow hover:shadow-lg transform hover:scale-105 transition-transform delay-50 p-4 rounded w-full md:w-11/12 flex flex-col md:flex-row flex-wrap items-center mb-4">
