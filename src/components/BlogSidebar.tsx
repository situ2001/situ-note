  ...
  return (
    <div className="hidden md:flex flex-col justify-center md:w-3/12 shadow-lg rounded max-h-screen fixed top-0 right-0 h-screen">
      <div className="text-4xl">
        <p className="cursor-pointer my-4 border-l-4 border-blue-300 pl-7 bg-gradient-to-l from-purple-50 to-blue-50">
          POST
        </p>
        <p className="my-4 border-l-4 border-white pl-7">ARCHIVE</p>
        <p className="my-4 border-l-4 border-white pl-7">CATEGORY</p>
      </div>
